                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @if ($suratKeputusan->status == 'Persetujuan Kasi')
                                    <form action="{{ route('kasi.kirim.surat.keputusan.kekabid', $pengajuan->id) }}"
                                        method="POST" id="myForm" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row mt-5">
                                            <div class="col-12 mt-5">
                                                <h2>Setujui dan Kirim Surat Keputusan Ke KABID</h2>

...
@section('title')
    Menunggu Approve Surat Keputusan
@endsection
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        Menunggu Approve Surat Keputusan</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Menunggu Approve Surat Keputusan</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body text-center">
                                <h3>
                                    Harap Menunggu KASI, KABID, dan KADIS Melakukan Approve Surat Keputusan
                                </h3>
                            </div>
                        </div>
                    </div>

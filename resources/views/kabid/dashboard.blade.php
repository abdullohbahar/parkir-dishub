                                    ...
                                    <table class="table table-borderd table-striped">
                                        ...
                                        @forelse ($perluPersetujuan as $perlu)
                                            <tr>
                                                ...
                                                <td>{{ $perlu->status }}</td>
                                                <td>
                                                    <a href="{{ route('kabid.verifikasi.surat.keputusan', $perlu->pengajuan_id) }}"
                                                        class="btn btn-sm btn-info">
                                                        {{ $perlu->status == 'Persetujuan Kabid' ? 'Verifikasi Surat Keputusan' : 'Lihat Surat Keputusan' }}
                                                    </a>
                                                </td>
                                            </tr>
                                        @empty
                                    ...
                                    <table class="table table-borderd table-striped">
                                        ...
                                        @forelse ($telahDisetujui as $setuju)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('kabid.verifikasi.surat.keputusan', $setuju->pengajuan_id) }}"
